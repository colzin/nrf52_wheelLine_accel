 ...
 *      Author: Collin Moore
 *      Taken from ble_uart example's main.c
 */
...
void bleStuff_printBLEVersion(void)
{
    ...
    NRF_LOG_DEBUG("BLE version %d.%d, company ID 0x%04x", version.version_number, version.subversion_number,
                  version.company_id);
}
